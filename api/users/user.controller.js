const { create, getInstance, getUsers, updateUser, deleteUser, getUserByUserEmail, createInstance, updateUserInstance, deleteUserInstance, getarcUsers, getAUC } = require("./user.service");
...
module.exports = {
    ...
    updateInstance: (req, res) => {
        const body = req.body;
        updateUserInstance(body, (err, results) => {
            if (err) {
                console.log(err);
                return res.status(500).json({
                    success: 0,
                    message: "Unable to update instance"
                });
    ...
    login: (req, res) => {
        ...
        getUserByUserEmail(body.email, (err, results) => {
            ...
            if (result) {
                ...
                const jsontoken = sign({ result: results }, authKey, { expiresIn: "5h" });
                return res.json({
                    success: 1,
